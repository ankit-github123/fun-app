  ...
  return (
    <div className="container-fluid row getstartmain">
      ...
      <div className="col-lg-8 getstarted-body">
        <div class="card mb-3">
          <img src={youtubepic} class="card-img-top" alt="..." />
          <div class="card-body">
            <h5 class="card-title">X-Stream {"{Youtube}"}</h5>
            <p class="card-text">
        ...
        <div class="card mb-3">
          <img src={newspic} class="card-img-top" alt="..." />
          <div class="card-body">
            <h5 class="card-title">News {"{news-api}"}</h5>
            <p class="card-text">
        ...
        <div class="card mb-3">
          <img src={laughstart} class="card-img-top" alt="..." />
          <div class="card-body">
            <h5 class="card-title">Jokes & Riddles {"{jokes-api}"}</h5>
            <p class="card-text">
              ...
              <br />
              <br />
              <b> A riddle</b> is a word puzzle in which one
              player asks a confusing question, and the other player has to
              figure out its meaning. Riddles often rely on puns and double
              entendres – in other words, the key to solving the riddle is to
              realize that one of the words is being used in a surprising or
              unexpected way.
            </p>
            <p class="card-text">
              <small class="text-muted">Last updated 3 mins ago</small>
        ...
        <div class="card mb-3">
          <img src={writerstart} class="card-img-top" alt="..." />
          <div class="card-body">
            <h5 class="card-title">Quotes & Thoughts {"{Quotes api}"}</h5>
            <p class="card-text">
              <b>Online News</b> are one of the most important documents. They
              can be said to be the <b>powerhouse of information.</b> Moreover,
              they offer us other benefits as well which helps us in our lives.
              ...
              <br />
              <br />
              <b>News link</b> uses News api to surf various news the internet
              with latency of 18ms.You can search on news and read all the
              current hot topics.
              <br />
              <br />
              <b>Online News reading</b> is one of the most beneficial habits.
        ...
        <div class="card mb-3">
          <img src={triviastart} class="card-img-top" alt="..." />
          <div class="card-body">
            <h5 class="card-title">News {"{news-api}"}</h5>
            <p class="card-text">
              <b>Online News</b> are one of the most important documents. They
